        ...
        success:function(response){
            ...
            for(i=0; i<response.length;i++){
                ...
                for(i=0; i<misItems.length; i++){
                    ...
                    $("#miListaCategory").append('<td><button class = "botonCategory2" onclick="cargarDatosCategory('+misItems[i].id+')">Editar Producto!</button></td>');
                    $("#miListaCategory").append('<td><button class = "botonCategory2" onclick="actualizarCategory('+misItems[i].id+')">Actualizar Producto!</button></td>');
                    $("#miListaCategory").append("</tr>");
                }
            }
        },
